...
//  RickAndMorty
//
//  Created by Charles Opitz on 1/14/26.
//
...
final class RMSearchResultsView: UIView {
    ...
    //MARK: - Setting shit up down below!
...
extension RMSearchResultsView: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: RMLocationTableViewCell.cellIdentifier, for: indexPath) as? RMLocationTableViewCell else {
            fatalError("Shit got real FUCKED UP!")
        }
...
extension RMSearchResultsView: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        // Character | Episode cells needed here.  And spoiler alert, they're quite different
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        if currentViewModel is RMCharacterCollectionViewCellViewModel {
            // in this case, do character cell size
            let width = (bounds.width-30)/2
            return CGSize(
                width: width, height: width * 1.5
            )
        }
        //otherwise, return episode cell size
            ...
            if offset >= (totalContentHeight - totalScrollViewFixedHeight - 120) {
                ...
                viewModel.fetchAdditionalResults { [weak self] newResults in
                    ...
                    DispatchQueue.main.async {
                        ...
                        //print("Should add more result cells for search results, there should now be a total of \(newResults.count).")
